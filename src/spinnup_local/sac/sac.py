...
def sac(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
        ...
        max_ep_len=1000, logger_kwargs=dict(), save_freq=1,layer_norm =False,
    ...
    with tf.variable_scope('main'):
        mu, pi, logp_pi, q1, q2, q1_pi, q2_pi, v = actor_critic(x_ph, a_ph,layer_norm = layer_norm, **ac_kwargs)
    
    # Target value network
    with tf.variable_scope('target'):
        _, _, _, _, _, _, _, v_targ  = actor_critic(x2_ph, a_ph,layer_norm = layer_norm, **ac_kwargs)
    ...
    var_counts = tuple(core.count_vars(scope) for scope in 
                       ['main/pi', 'main/q1', 'main/q2', 'main/v', 'main','main/v','target/v'])
    ...
    def test_agent(n=10):
        ...
        for j in range(n):
            ...
            while not(d or (ep_len == max_ep_len)):
                ...
                a = get_action(o, True)
                o, r, d, _ = test_env.step(scale_action(a))
                ep_ret += r
                ep_len += 1
